...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      v[t][3-choice1[s,t]] <- v[t][3-choice1[s,t]] + coh[s] * against[s,t];
      v[t][choice1[s,t]]   <- v[t][choice1[s,t]]   + coh[s] * with[s,t];
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      v2[t][3-choice1[s,t]] <- v2[t][3-choice1[s,t]] + coh[s] * against[s,t];
      v2[t][choice1[s,t]]   <- v2[t][choice1[s,t]]   + coh[s] * with[s,t];
