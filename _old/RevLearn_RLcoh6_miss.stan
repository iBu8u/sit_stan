...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:obs[s+1] ) {
      ...
      v[t][3-choice1[t+cumobs[s]]] <- v[t][3-choice1[t+cumobs[s]]] + coh[s] * against[t+cumobs[s]];
      v[t][choice1[t+cumobs[s]]]   <- v[t][choice1[t+cumobs[s]]]   + coh[s] * with[t+cumobs[s]];
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:obs[s+1] ) {
      v2[t][3-choice1[t+cumobs[s]]] <- v2[t][3-choice1[t+cumobs[s]]] + coh[s] * against[t+cumobs[s]];
      v2[t][choice1[t+cumobs[s]]]   <- v2[t][choice1[t+cumobs[s]]]   + coh[s] * with[t+cumobs[s]];
